 ...
 * @author Fer
 */
public class GeoJsonObjectCustomConverter extends BidirectionalConverter<LineString, GeoJsonObject> {

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(GeoJsonObjectCustomConverter.class);

    @Override
    public GeoJsonObject convertTo(LineString source, Type<GeoJsonObject> destinationType) {
        ...
        try {
            ...
            Logger.getLogger(GeoJsonObjectCustomConverter.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }

    @Override
    public LineString convertFrom(GeoJsonObject source, Type<LineString> destinationType) {
        try {
