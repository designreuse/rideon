...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li><a href="<c:url value="/groups/${group.id}"/>">${group.name}</a></li>
        <li class="active"><spring:message code="jsp.group.adminmembers"/></li>
    </ol>
    <h1><small><spring:message code="jsp.group.members"/></small></h1>
    <hr>
                    ...
                    <ul class="list-group">
                        <c:forEach var="member" items="${members}">
                            <li class="list-group-item">
                                ...
                                <c:if test="${group.owner.username != member.username}">
                                    <button class="pull-right btn btn-sm btn-danger" id="removeUser" data-userid="${member.username}">
...
<h4><spring:message code="jsp.group.addmembers"/></h4>
<hr>
<div class="row">
    <div class="col-sm-4">
        <div class="panel panel-default">
    ...
    <div class="col-sm-7 col-md-6 col-md-8">
        ...
        <a href="<c:url value="/groups/${group.id}"/>" class="btn btn-danger"><spring:message code="jsp.form.cancel"/></a>
    </div>
</div>
<script>
            ...
            $("form#search-form").submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (obj.length > 0) {
                            $.each(obj, function() {
                                if (this["username"] !== '${group.owner.username}') {
    ...
    function removeUser(user) {
        var baseUrl = "<c:url value="/groups/${group.id}/members/"/>";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                window.location.href = "<c:url value="/groups/${group.id}/members" />";
            },
            error: function(e) {
    ...
    function sendChanges() {
        ...
        if (objectArray.length !== 0) {
            $.ajax({
                type: 'POST',
                url: '<c:url value="/groups/${group.id}/members/add"/>',
                data: jsonData,
