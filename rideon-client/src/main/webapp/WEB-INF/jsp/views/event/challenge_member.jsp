                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form:form method="POST" commandName="gpxForm" action="${practicePostUrl}" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-small btn-success" type="submit" value=""><span class="fa fa-upload" style="margin-right: 4px;">
                                                    </span> <spring:message code="jsp.form.uploadfile"/></button>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
