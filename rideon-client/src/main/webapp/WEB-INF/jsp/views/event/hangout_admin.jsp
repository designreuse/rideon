                ...
                <div class="row">
                    <div class="col-sm-4" >
                        ...
                        <span class="btn btn-sm btn-default"><i class="glyphicon glyphicon-calendar">
                            </i> <fmt:formatDate type="both" value="${event.eventDate}" pattern="dd-MM-yyyy hh:mm" />
                        </span>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<c:url value='/${member.username}'/>" style="display:inline-block; width: 100%; height: 100%;">
                                                <img src="<c:url value='/${member.username}/thumbnail'/>" class="media img-thumbnail" style="width: 30px; 
