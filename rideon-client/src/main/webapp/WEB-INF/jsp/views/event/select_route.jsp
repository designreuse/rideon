        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pull-right">
                    <button id="saveRoute" class="btn btn-primary"><i class="fa fa-fw fa-save"></i> Guardar</button>
                </div>
            </div>
        </div>
...
//            console.log(bounds);
            ...
            var url = "<c:url value="/search/routes"/>";
                                ...
                                $("#routeList").append("\
                                            <div class='checkbox list-group-item' id='" + ob.fid + "'>\n\
                                                ...
                                                <div class='pull-right action-buttons'>\n\
                                                    <a  href='" + routeUrl + ob.fid + "'><span class='divider'></span><i class='fa fa-fw fa-lg fa-eye'></i></a>\n\
                                                </div>\n\
                                            </div>");

                                marker.events.register("click", marker, function() {
                                    var uri = '<c:url value="/routes/"/>';
...
//                                feature.cluster.length
            ...
            $("#saveRoute").click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<c:url value="/events/${eventId}/routes"/>',
                    data: {'routeId': id},
