...
<div class="row">
    ...
    <div class=" col-sm-5 col-md-4 col-lg-4  col-md-offset-2 col-lg-offset-2">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Prácticas Recientes
                <a class="btn btn-xs btn-primary pull-right" href="<c:url value='/${user.username}/practices'/>">Ver Prácticas</a>
            </div>
            <div class="panel-body">
                <c:choose>
                    <c:when test="${fn:length(practices) gt 0}">
                        <table class="table table-hover table-bordered">
                            <c:forEach items="${practices}" var="practice">
                                <tr>
                                    <td class="">
                                        <a style="display:inline-block; width: 100%; height: 100%;" href="<c:url value='${userId}/practices/${practice.id}'/>">
