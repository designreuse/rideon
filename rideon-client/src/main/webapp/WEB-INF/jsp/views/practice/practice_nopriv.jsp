...
<body>
    ...
    <ol class=" breadcrumb">
        ...
        <li class="active">${practice.owner.fullName}</li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="list-group" id="segments">
                                        <a href='#' class='list-group-item active' id='fullRoute'><spring:message code="jsp.route.fullRoute"/></a>
                                        <c:forEach var="segment" items='${practice.segmentsResults}' varStatus="loopCount">
                                            <a href='#' class='list-group-item segment' data-segmentid='${segment.id.segmentId}' 
                                               ...
                                               data-mediumspeed='${segment.mediumspeed}'> <spring:message code="jsp.segment.segment"/> ${loopCount.count}</a>
                                        </c:forEach>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div id="practice-menu"  style="margin-top: 10px; margin-bottom: 5px; height: 35px; ">
                        <div class="btn-group pull-right " >
                            <a href="<c:url value="/practices/${practice.id}.gpx"/>" class="btn btn-sm btn-primary">
                                <span class="fa fa-download" style="margin-right :5px"></span><spring:message code="jsp.practice.downloadgpx"/></a>
                        </div>
                    </div>
                </div>
            </div>
