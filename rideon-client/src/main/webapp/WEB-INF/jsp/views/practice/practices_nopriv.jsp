...
<body>
    <ol class=" breadcrumb">
        <li class="active"><a href="<c:url value="/${userId}"/>">${userId}</a></li>
        <li><spring:message code="jsp.practice.practices"/></li>
    </ol>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><spring:message code="jsp.practice.addpractice"/></h4>
                </div>
    ...
    <script>
        ...
        $("#calendar").fullCalendar({
            ...
            eventClick: function(calEvent, jsEvent, view) {
                var url = "<c:url value="/${userId}/practices/" />";
                url = url + calEvent.id;
